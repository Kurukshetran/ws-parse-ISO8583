...
public class EntradaBean { 
    ...
    private String idAnular;  // 12 de la transacci�n a anular
    
    /*26092013 Claro servicios*/
    private String productoServicio;
    private String tipoProdServ;    // 1            x  m�vil 1; m�vilLDI 2; dni 5; fijo 6
    private String prefijo;         // 3
    private String numRecibo;        //16           x
    /*1 campo claro anulacion 18102013*/
    private String auditoriaOrig;      //12             X
    /*14102013 se a�ade 1 campo: la fecha original de una transaccion para extorno CMR*/
